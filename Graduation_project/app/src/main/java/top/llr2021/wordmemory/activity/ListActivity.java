...
import top.llr2021.wordmemory.adapter.WordListAdapter;
...
public class ListActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        currentAllNumber = ConstantData.wordTotalNumberById(LitePal.where("userId = ?", ConfigData.getQQNumLogged() + "").find(UserConfig.class).get(0).getCurrentBookId());
