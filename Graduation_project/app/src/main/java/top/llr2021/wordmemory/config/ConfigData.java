...
public class ConfigData {
    ...
    // 当前已登录的用户ID
    public static String QQNumLogged;
    ...
    // 获得QQNumLogged值
    public static String getQQNumLogged() {
        SharedPreferences preferences = MyApplication.getContext().getSharedPreferences(SharedDataName, Context.MODE_PRIVATE);
        QQNumLogged = preferences.getString(QQNumLoggedName, null);
        return QQNumLogged;
    }

    // 设置QQNumLogged值
    public static void setQQNumLogged(String QQNumLogged) {
        SharedPreferences.Editor editor = MyApplication.getContext().getSharedPreferences(SharedDataName, Context.MODE_PRIVATE).edit();
        editor.putString(QQNumLoggedName, QQNumLogged);
        editor.apply();
    }
