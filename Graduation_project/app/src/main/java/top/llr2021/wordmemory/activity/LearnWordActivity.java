...
import top.llr2021.wordmemory.adapter.MeanChoiceAdapter;
...
import top.llr2021.wordmemory.listener.OnItemClickListener;
...
public class LearnWordActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void updateStatus() {
        ...
        Log.d(TAG, "needreviewwords当前大小" + WordController.needReviewWords.size());
